...
namespace BaseFramework.WebPages
{
    public class MainPage
    {
        ...
        readonly static string STR_FIRSTNAME = "//input[@id='_fNameInput']";
        readonly static string STR_LASTNAME = "//input[@id='_lNameInput']";
        ...
        private IWebElement objFirstName => _driver.FindElement(By.XPath(STR_FIRSTNAME));
        private IWebElement objLastName => _driver.FindElement(By.XPath(STR_LASTNAME));
        ...
        public void fnEnterFirstName(string pstrFirstName)
        {
            objFirstName.Clear();
        ...
        public void fnEnterLastName(string pstrLastName)
        {
            objLastName.Clear();
