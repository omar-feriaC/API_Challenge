...
namespace BaseFramework.Helpers
{
    ...
    {
        public static mdlPostEmployee GetUserAuthToken(String username, String password)
        {
            ...
            return default(mdlPostEmployee);  //Replace this with an actual return that is useful.
        }
    }
}
