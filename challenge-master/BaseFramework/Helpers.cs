...
namespace BaseFramework.Helpers
{
    ...
    {
        public static PostEmployee GetUserAuthToken(String username, String password)
        {
            ...
            return default(PostEmployee);  //Replace this with an actual return that is useful.
        }
    }
}
